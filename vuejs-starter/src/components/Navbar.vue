...
const userLink = [
    { name: 'Mon profil', href: '/me', isAuth: true },
    { name: 'Mes favoris', href: '/me/favorites', isAuth: true },
    { name: 'Mes ventes', href: '/me/ads', isAuth: true },
    { name: 'Mes messages', href: '/me/messages', isAuth: true },
    { name: 'Se déconnecter', href: '/logout', isAuth: true },
    { name: 'Se connecter', href: '/login', isAuth: false },
    { name: 'S\'inscrire', href: '/register', isAuth: false },
]
    ...
    <nav class="w-full flex px-52 bg-white/10 sticky items-center z-20">
        <div class="flex h-24 items-center relative justify-between w-full">
            ...
            <div class="w-1/4 flex justify-end items-center space-x-3 relative">
                ...
                <div class="absolute bg-white w-52 max-h-[18rem] h-fit top-12 rounded-lg p-2 space-y-2 flex justify-start flex-col"
                    v-show="showUserMenu">
