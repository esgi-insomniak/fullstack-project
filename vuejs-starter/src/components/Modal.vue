                        ...
                        <DialogPanel
                            ...
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    <div v-if="props.icon"
                                        ...
                                        :class="props.icon.bgColor">
                                        <props.icon.type class="h-6 w-6" :class="props.icon.textColor"
                                            aria-hidden="true" />
                                    </div>
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <DialogTitle v-if="props.title" as="h3"
                            ...
                            <div v-if="props.buttons" class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                <button v-for="(button, index) in props.buttons" :key="index" type="button"
                                    :class="button.class" @click="button.action">{{ button.text }}</button>
                            </div>
                        </DialogPanel>
                    </TransitionChild>
                </div>
