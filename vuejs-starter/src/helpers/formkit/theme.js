export default {
    ...
    checkbox: {
        outer: 'mb-5',
        label: 'mb-1 font-bold text-sm',
        inner: 'border border-none rounded-lg mb-1 overflow-hidden focus-within:border-blue-500',
        input: 'px-3 border-none text-base text-gray-700 placeholder-gray-400',
    ...
    textarea: {
        ...
        input: 'w-full px-3 border-none text-base text-white placeholder-gray-400',
        help: 'text-xs text-gray-500',
        messages: 'list-none p-0 mt-1 mb-0',
        message: 'text-red-500 mb-1 text-xs'
    },
